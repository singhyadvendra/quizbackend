...
* [OAuth2 Client](https://docs.spring.io/spring-boot/4.0.1-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
...
* [Flyway Migration](https://docs.spring.io/spring-boot/4.0.1-SNAPSHOT/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
